...
\input{../../problemstellung} % Kapitel: Problemstellung

\input{../../forschungsstand} % Kapitel: Aktueller Forschungsstand

\input{../../forschungsluecke} % Kapitel: Identifizierung der Forschungslücke
...
\input{../../auswahlbibliografie} % Kapitel: Auswahlbibliografien
