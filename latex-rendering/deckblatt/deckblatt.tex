...
\newgeometry{left=2.5cm, right=2.5cm, bottom=2.5cm, top=2.5cm} %Stellt den Seitenrand dieser Seite um
...
\end{titlepage}
\restoregeometry %Stellt wieder auf die globale Seitenrandbeschreibung um
